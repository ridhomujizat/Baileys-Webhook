...
import { LogOut, LayoutDashboard, MessageSquare, Download, Sun, Moon } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex transition-colors duration-200">
            ...
            <aside className="w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col transition-colors duration-200">
                <div className="p-6 border-b border-gray-200 dark:border-gray-700">
                    ...
                    {/* <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 ml-10">Whatsapp Webhook</p> */}
                </div>
